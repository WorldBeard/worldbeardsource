...
namespace EarthCoreEngine.Input
{
    public class Mouse
    {
        ...
        // START: Constructor implements MouseClick and MouseDown/Up events using _openGLControl
        ...
        private void UpdateMousePosition()
        {
            ...
            EarthCoreEngine.Point adjustedMousePoint = new EarthCoreEngine.Point();
